        ...
        <div className={`${cardClass} group-hover:scale-105 transform transition-all duration-300`}>
          ...
          <div className="space-y-3">
            ...
            <button 
              ...
              className="w-full btn-primary flex items-center justify-center space-x-2 mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isAddingToCart ? (
                <>

...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await register(formData.name.trim(), formData.email.trim(), formData.password, formData.isArtisan)
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="appearance-none relative block w-full px-12 py-3 border border-custom rounded-lg placeholder-secondary text-primary bg-tertiary focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent"

          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="bg-tertiary rounded-lg shadow-lg p-6">
                  ...
                  <div className="space-y-6">
                    {cart.items.map((item) => (
                      <div key={item.productId} className="flex items-center space-x-4 p-4 border border-custom rounded-lg bg-secondary">
                        {/* Product Image */}
              ...
              <div className="lg:col-span-1">
                <div className="bg-tertiary rounded-lg shadow-lg p-6 sticky top-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-t pt-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-lg font-bold text-accent">${Number(cart.total || 0).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
